...
public class CreateSkillTest extends BaseTest {
 private String skillContent = SKILL + timeStamp();
    ...
    public void skillCreated_When_ValidDataProvided() {
        ...
        String requestBody = format(SKILL_BODY, CATEGORY_ID_SKILL, CATEGORY_NAME, skillContent, SKILL_ID);
        ...
        assertEquals(response.getBody().jsonPath().get("skill"), skillContent, "Response is different than provided.");
